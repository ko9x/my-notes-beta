...
var NoteAddComponent = (function () {
    ...
    NoteAddComponent.prototype.pasteCodeWrap = function (section) {
        var destination = document.getElementById(section).focus();
        document.execCommand('insertText', false, '<pre><code> </code></pre>');
    };
    NoteAddComponent.prototype.pastePTag = function (section) {
        var destination = document.getElementById(section).focus();
...
var NoteEditComponent = (function () {
    ...
    NoteEditComponent.prototype.pasteCodeWrap = function (section) {
        var destination = document.getElementById(section).focus();
        document.execCommand('insertText', false, '<pre><code> </code></pre>');
    };
    NoteEditComponent.prototype.pastePTag = function (section) {
        var destination = document.getElementById(section).focus();
        document.execCommand('insertText', false, '<p> </p>');
    };
    NoteEditComponent.prototype.pasteHRef = function (section) {
        var destination = document.getElementById(section).focus();
        document.execCommand('insertText', false, '<a href="" target="_blank"> <a/>');
    };
